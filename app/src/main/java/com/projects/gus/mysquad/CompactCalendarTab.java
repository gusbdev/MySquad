...
public class CompactCalendarTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        compactCalendarView.setListener(new CompactCalendarView.CompactCalendarViewListener() {
            ...
            public void onDayClick(Date dateClicked) {
                ...
                passDayClicked = dateFormatForDisplaying.format(dateClicked);
        ...
        FloatingActionButton fab = mainTabView.findViewById(R.id.fab);
    ...
    public void open(View view) {
        ...
        alertDialogBuilder.setTitle("Adicionar evento");
        alertDialogBuilder.setMessage("Descrição do evento: ");
